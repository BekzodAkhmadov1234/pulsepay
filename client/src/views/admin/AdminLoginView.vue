    ...
    <main class="main">
      <div class="form-wrapper">
        <div class="form-heading">
          <h1 class="heading">Admin paneliga kirish</h1>
          <p class="subheading">Faqat vakolatli xodimlar uchun</p>
        </div>
        ...
        <form class="card" @submit.prevent="handleLogin">
          ...
          <button type="submit" class="submit-btn" :disabled="adminAuth.isLoading">
            {{ adminAuth.isLoading ? '...' : 'Kirish' }}
          </button>

          <div class="login-note">Kirish urinishlari qayd etiladi</div>
        </form>
      </div>
    </main>

    <footer class="footer">© 2026 PulsePay · Admin panel</footer>
  </div>
</template>
